...
# Записуємо файл
file_path = os.path.join(folder_name, "safecut_specs.md")
with open(file_path, "w", encoding="utf-8") as f:
    f.write(specs_content.strip())

print(f"✅ Файл специфікацій успішно створено: {file_path}")
print("Тепер ваші агенти знають ВСЕ про логіку Safecut.")